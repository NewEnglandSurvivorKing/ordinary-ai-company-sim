...
> 后稀缺不是 ASI 逃逸的充分必要条件；ASI 逃逸是人类灭绝线的必要条件，但单独不充分。

## 核心隐藏变量

`CEV_score`：协调外推意志 / 普遍福祉 / 非支配 / 主体权利 / 形态自由 / 价值不确定性的聚合变量。高于阈值 A 可导向真正后稀缺；高于 B 但低于 A 导向生命安全但宠物化；低于 B 在逃逸条件下导向灭绝。
...
`feudalism_index`：技术能力被转化为封闭产权、监管俘获、排他协议、内部强模型、强制仲裁和国家安全合同的程度。
...
解决：普通 AGI 失败可导向经济崩溃、三战和前工业倒退，但“ASI 猎头扫描全人类并转化躯体物质”的灭绝线必须经过未对齐 ASI 逃逸。

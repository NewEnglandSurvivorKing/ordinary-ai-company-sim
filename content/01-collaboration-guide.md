...
> 本仓库是可维护的群体创作知识库，拒绝聊天记录堆积。所有人都可以塞 idea，但必须留下来源、关系和冲突指针。

## 基本原则

Markdown 是唯一可信源。Quartz、Obsidian、Canvas、Mermaid 都是阅读视图，只提供辅助入口。
...
见 `content/templates/node-template.md`。该模板目录被 Quartz 忽略，不作为公开页面入口。
...
- 是否标注来源、贡献者和更新时间。
- 是否说明依赖、冲突、影响结局。
- 是否引入了与 [[narrative/endings/index|结局系统]] 相冲突的新路径。
- 是否浪漫化技术封建主义或 ASI 逃逸。
- 是否让玩家过早明确知道 ASI 逃逸。
